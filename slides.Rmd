---
title: "Building Open Science Scientific Communities "
subtitle: "⚔<br/>w"
...
.footnote[brief credit: [Mike Croucher](https://github.com/mikecroucher/RSE_2017_keynote_presentation)]
 ...
 * [Software Carpentriy](https://software-carpentry.org/)
...
- [flash mobbing stack overflow]()
- [Rstudio]() & [rOpenSci]() discussion boards
...
### [OxShef](https://oxshef.github.io/oxshef_charts/)
...
### communication imperative for the spread of **tacit knowledge**

> the valuable context-based experiences that cannot easily be captured, codified and stored

--

#### well moderated slack / gitter channels e.g. #R4DS
 * moderator can encourage more useful content to blogs, discussion boards etc.
...
- Leveraging technology and automation helps
...
- friendly, active community catalysers make a huge impact!
    * e.g.  **Maëlle Salmon** ([@maelle]()),  and **Stephanie Butland** ([@]()) at **rOpensci** & **#rstats**, **Jesse Meghan** [@kierisi]() for #R4DS
...
### organise a hack
#### [Reprohack 2017 @ OpenCon London](http://rse.shef.ac.uk/blog/opencon_london/):
...
### jump on to a wider event
#### [Mozilla Global Sprint 2017 @ TUoS](http://rse.shef.ac.uk/blog/mozsprint-2017-at-the-university-of-sheffield/):
---

### jump on to a wider event
### [R Users Group Hacktoberfest series](http://rse.shef.ac.uk/blog/sheffieldR-hacktoberfest/):

---

## meetups / coding clubs

- ### establish good rhythm.
...
- Link members to broader communities
...
- #### Teaching 
    - Software carpentry
    - Bespoke, community driven training
   
   <blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">And of course, super friendly <a href="https://twitter.com/swcarpentry?ref_src=twsrc%5Etfw">@swcarpentry</a> backup by these fine folk <a href="https://twitter.com/jezcope?ref_src=twsrc%5Etfw">@jezcope</a> <a href="https://twitter.com/jamesbraders?ref_src=twsrc%5Etfw">@jamesbraders</a> <a href="https://twitter.com/WillFurnass?ref_src=twsrc%5Etfw">@WillFurnass</a> <a href="https://twitter.com/katkoler?ref_src=twsrc%5Etfw">@katkoler</a>! <a href="https://t.co/PN6sG1fc7N">pic.twitter.com/PN6sG1fc7N</a></p>&mdash; annakrystalli (@annakrystalli) <a href="https://twitter.com/annakrystalli/status/898113024816533504?ref_src=twsrc%5Etfw">August 17, 2017</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
